...
BotId = _reflection.GeneratedProtocolMessageType('BotId', (_message.Message,), {
  'DESCRIPTOR' : _BOTID,
...
BallSpeedMeasurement = _reflection.GeneratedProtocolMessageType('BallSpeedMeasurement', (_message.Message,), {
