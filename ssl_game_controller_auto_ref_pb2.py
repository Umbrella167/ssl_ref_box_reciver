...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[ssl__game__controller__common__pb2.DESCRIPTOR,ssl__game__event__2019__pb2.DESCRIPTOR,])
...
_AUTOREFREGISTRATION.fields_by_name['signature'].message_type = ssl__game__controller__common__pb2._SIGNATURE
_AUTOREFTOCONTROLLER.fields_by_name['signature'].message_type = ssl__game__controller__common__pb2._SIGNATURE
_AUTOREFTOCONTROLLER.fields_by_name['game_event'].message_type = ssl__game__event__2019__pb2._GAMEEVENT
_AUTOREFTOCONTROLLER.fields_by_name['auto_ref_message'].message_type = _AUTOREFMESSAGE
_CONTROLLERTOAUTOREF.fields_by_name['controller_reply'].message_type = ssl__game__controller__common__pb2._CONTROLLERREPLY
...
_AUTOREFMESSAGE_WAITFORBOTS_VIOLATOR.fields_by_name['bot_id'].message_type = ssl__game__controller__common__pb2._BOTID
...
AutoRefMessage = _reflection.GeneratedProtocolMessageType('AutoRefMessage', (_message.Message,), {

  'WaitForBots' : _reflection.GeneratedProtocolMessageType('WaitForBots', (_message.Message,), {
...
_AUTOREFTOCONTROLLER.fields_by_name['auto_ref_message']._options = None
